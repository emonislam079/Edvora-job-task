  ...
  <Row>
      <Row>
        ...
        <Dropdown className='text-center'>
          ...
          <Col xs={12} md={9} className="Product-container" >
            ...
            <h1 id="apple" className='productName'>Alibaba</h1>
            <hr className='hr'></hr>
            <div>
                  <Carousel>
                          <Carousel.Item>
      ...
      <div>
            <Carousel>
                    ...
                    <Row xs={1} md={3} className="g-4 Product-Container">
            {
                product.filter(product=> product.brand_name = "Alibaba").slice(12,15).map(product =><div
                product ={product}
                >
                  ...
                  <Container>
                    ...
                    <Row xs={1} md={3} className="g-4 Product-Container">
            {
                product.filter(product=> product.brand_name = "Alibaba").slice(16,19).map(product =><div
                product ={product}
                >
                  ...
                  <Container>
                    ...
                    <Row xs={1} md={3} className="g-4 Product-Container">
            {
                product.filter(product=> product.brand_name = "Alibaba").slice(20,23).map(product =><div
                product ={product}
                >
