...
const Apple = () => {
  ...
  <Row>
      ...
      <h1 id="alibaba" className='productName2'>Apple</h1>
      <hr className='hr'></hr>
      <div>
            <Carousel>
                    <Carousel.Item>
                    <Row xs={1} md={3} className="g-4 Product-Container">
            {
                product.filter(product=> product.brand_name = "Apple").slice(12, 15).map(product =><div
                product ={product}
                >
                  ...
                  <Container>
                    ...
                    <Row xs={1} md={3} className="g-4 Product-Container">
            {
                product.filter(product=> product.brand_name = "Apple").slice(16,19).map(product =><div
                product ={product}
                >
                  ...
                  <Container>
                    ...
                    <Row xs={1} md={3} className="g-4 Product-Container">
            {
                product.filter(product=> product.brand_name = "Apple").slice(20,23).map(product =><div
                product ={product}
                >
