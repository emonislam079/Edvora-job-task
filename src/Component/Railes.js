  ...
  <Row>
      <Row>
          ...
          <Link className='text-decoration-none ms-3 text-light d-block' to="/apple">Apple</Link>
            ...
            <Link className='text-decoration-none ms-3 text-light d-block' to="/rails">Raills</Link>
        ...
        <Dropdown className='text-center'>
          ...
          <Col xs={12} md={9} className="Product-container" >
            ...
            <h1 id="apple" className='productName'>Raills</h1>
            <hr className='hr'></hr>
            <div>
                  <Carousel>
                          <Carousel.Item>
                  ...
                  {
                      product.filter(product=> product.brand_name = "Raills").slice(0,3).map(product =><div
                      product ={product}
                      >
                    ...
                    <Row xs={1} md={3} className="g-4 Product-Container">
            {
                product.filter(product=> product.brand_name = "Raills").slice(4,7).map(product =><div
                product ={product}
                >
                  ...
                  <Container>
                    ...
                    <Row xs={1} md={3} className="g-4 Product-Container">
            {
                product.filter(product=> product.brand_name = "Raills").slice(8,11).map(product =><div
                product ={product}
                >
      ...
      <h1 id="Raills" className='productName2'>Raills</h1>
      <hr className='hr'></hr>
      <div>
            <Carousel>
                    <Carousel.Item>
                    <Row xs={1} md={3} className="g-4 Product-Container">
            {
                product.filter(product=> product.brand_name = "Raills").slice(12,15).map(product =><div
                product ={product}
                >
                  ...
                  <Container>
                    ...
                    <Row xs={1} md={3} className="g-4 Product-Container">
            {
                product.filter(product=> product.brand_name = "Raills").slice(16,19).map(product =><div
                product ={product}
                >
                  ...
                  <Container>
                    ...
                    <Row xs={1} md={3} className="g-4 Product-Container">
            {
                product.filter(product=> product.brand_name = "Raills").slice(20,23).map(product =><div
                product ={product}
                >
