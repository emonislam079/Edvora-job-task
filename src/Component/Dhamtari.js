...
const Dhamtari = () => {
  ...
  <Row>
        ...
        <Dropdown className='text-center'>
          ...
          <Col xs={12} md={9} className="Product-container" >
            ...
            <div>
                  ...
                  {
                      product.filter(product=> product.address.city = "Dhamtari").slice(0,3).map(product =><div
                      product ={product}
                      >
                    ...
                    <Row xs={1} md={3} className="g-4 Product-Container">
            {
                product.filter(product=> product.address.city = "Dhamtari").slice(4,7).map(product =><div
                product ={product}
                >
                  ...
                  <Container>
                    ...
                    <Row xs={1} md={3} className="g-4 Product-Container">
            {
                product.filter(product=> product.address.city = "Dhamtari").slice(8,11).map(product =><div
                product ={product}
                >
      ...
      <h1 id="Dhamtari" className='productName2'>Products</h1>
      <hr className='hr'></hr>
      <div>
            <Carousel>
                    <Carousel.Item>
                    <Row xs={1} md={3} className="g-4 Product-Container">
            {
                product.filter(product=> product.address.city = "Dhamtari").slice(12,15).map(product =><div
                product ={product}
                >
                  ...
                  <Container>
                    ...
                    <Row xs={1} md={3} className="g-4 Product-Container">
            {
                product.filter(product=> product.address.city = "Dhamtari").slice(16,19).map(product =><div
                product ={product}
                >
                  ...
                  <Container>
                    ...
                    <Row xs={1} md={3} className="g-4 Product-Container">
            {
                product.filter(product=> product.address.city = "Dhamtari").slice(20,23).map(product =><div
                product ={product}
                >
